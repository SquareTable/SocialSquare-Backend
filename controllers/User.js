                                    ...
                                    bcrypt.hash(password, saltRounds).then(hashedPassword => {
                                        ...
                                        newUser.save().then(result => {
                                            ...
                                            newRefreshToken.save().then(refreshTokenResult => {
                                                return resolve(HTTPWTHandler.OK('Signup successful', userHandler.filterUserInformationToSend(result), {token: `Bearer ${token}`, refreshToken: `Bearer ${refreshToken}`, refreshTokenId: String(refreshTokenResult._id)}))
                                            }).catch(error => {
