                        ...
                        if (convoFound[0].isDirectMessage == false) {
                            if (idSent == new ObjectID(convoFound[0].ownerId)) {
                                if (convoFound[0].allowScreenShots == true) {
                                    Conversation.findOneAndUpdate({_id: {$eq: conversationId}}, {allowScreenShots: false}).then(function() {
                                        const serverMessagesId = new ObjectID()
                                        generateDate(function(datetime) {
                                    ...
                                    Conversation.findOneAndUpdate({_id: {$eq: conversationId}}, {allowScreenShots: true}).then(function() {
                                        const serverMessagesId = new ObjectID()
                                        generateDate(function(datetime) {
